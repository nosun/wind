...
return [
    ...
    'upload' => [
        ...
        'imagePathFormat' => '/uploads/image/{yy}{mm}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'catcherPathFormat' => '/uploads/image/{yyyy}/{mm}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'videoPathFormat' => '/uploads/video/{yyyy}/{mm}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
